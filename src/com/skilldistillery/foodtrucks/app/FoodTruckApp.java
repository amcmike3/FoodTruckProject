...
public class FoodTruckApp {
	...
	public static void main(String[] args) {
		...
		// loop until user enters quit or 5 trucks are entered
		while (!(input.equalsIgnoreCase("quit")) && index <= 4) {
			...
			scanner.nextLine();
			//make sure user enters correct rating range
	...
	private void printMax(FoodTruck[] foodTruckList) {
		int index = 0;
		int max = 0;
		FoodTruck winner = foodTruckList[0];
		String nameMax = "None";
		for (FoodTruck truck : foodTruckList) {
			if (truck == null) {
				continue;
		...
		System.out.println("Heres the rest of its info if you're interested.. \n" + winner);
